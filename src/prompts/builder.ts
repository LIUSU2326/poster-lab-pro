...
function formatPosterQualityDirection(modeState: WorkspaceModeState, assets: PromptAssetBinding[]): string {
  ...
  return [
    ...
    "Composition target: one clear hero focal point, strong foreground-midground-background depth, dynamic camera angle, readable silhouette hierarchy, environmental storytelling, a readable trailer-moment objective or character-vs-BOSS beat, and enough negative space for logo and slogan.",
    ...
    "One-second read target: the thumbnail must immediately communicate the game fantasy, the protagonist objective or BOSS threat, and the current project's core hook without relying on long text.",
