export const queue = [
  { label: "方案生成", detail: "五模式 brief", state: "完成", progress: 100, cost: "$0.42", time: "00:18" },
  { label: "批量渲染", detail: "12 / 16 张", state: "执行中", progress: 75, cost: "$3.86", time: "02:41" },
  { label: "模式约束检查", detail: "标识/图标规则", state: "排队", progress: 24, cost: "$0.60", time: "等待" },
  { label: "归档同步", detail: "保存到项目库", state: "待执行", progress: 0, cost: "$0.00", time: "等待" },
];
