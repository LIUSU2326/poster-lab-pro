...
export const providerManifests = {
  openai: ProviderManifestSchema.parse({
    ...
    modelSlots: {
      concept: ["gpt-5.2", "gpt-5.1", "gpt-5", "gpt-4.1"],
      image: ["gpt-image-2", "gpt-image-1.5", "gpt-image-1"],
      styleReference: ["gpt-5.2", "gpt-5.1", "gpt-5", "gpt-4.1"],
      compositionReference: ["gpt-5.2", "gpt-5.1", "gpt-5", "gpt-4.1"],
  ...
  aigocode: ProviderManifestSchema.parse({
    ...
    modelSlots: {
      concept: ["gpt-5.2", "gpt-5.1", "gpt-5-mini", "gpt-4.1-mini", "gpt-4.1"],
      image: ["gpt-image-2", "gpt-image-1.5", "gpt-image-1", "dall-e-3"],
      styleReference: ["gpt-5.2", "gpt-5.1", "gpt-5-mini", "gpt-4.1-mini"],
      compositionReference: ["gpt-5.2", "gpt-5.1", "gpt-5-mini", "gpt-4.1-mini"],
      imageEdit: ["gpt-image-2", "gpt-image-1.5", "gpt-image-1"],
    },
    supportedModes: ["poster", "collab", "announcement", "logo", "icon"],
  ...
  claude: ProviderManifestSchema.parse({
    ...
    modelSlots: {
      concept: ["claude-opus-4-1-20250805", "claude-sonnet-4-20250514", "claude-3-7-sonnet-20250219", "claude-3-5-haiku-20241022"],
      styleReference: ["claude-opus-4-1-20250805", "claude-sonnet-4-20250514", "claude-3-7-sonnet-20250219"],
      compositionReference: ["claude-opus-4-1-20250805", "claude-sonnet-4-20250514", "claude-3-7-sonnet-20250219"],
    },
    supportedModes: ["poster", "collab", "announcement", "logo", "icon"],
