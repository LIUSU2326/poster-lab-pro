...
export const providerManifests = {
  openai: ProviderManifestSchema.parse({
    ...
    imageGeneration: {
      referenceInput: "multipartEditImages",
      localReferenceHandling: "fetchInline",
      promptProfile: "standard",
	      promptMaxChars: 16000,
      textRendering: "medium",
      resultDelivery: "urlOrDataUrl",
      supportsImageEdit: true,
      notes: ["Uses the Images API. Uploaded visual references are sent through the image edits endpoint as multipart image inputs."],
    },
  ...
  custom: ProviderManifestSchema.parse({
    ...
    imageGeneration: {
      ...
      resultDelivery: "urlOrDataUrl",
      supportsImageEdit: true,
      notes: ["User-managed OpenAI-compatible relay. Base URL, API key, and model IDs are configured in the app."],
    },
    supportedModes: ["poster", "collab", "announcement", "logo", "icon"],
    notes: ["Generic OpenAI-compatible custom relay provider."],
  }),
  ...
  qwen: ProviderManifestSchema.parse({
    ...
    imageGeneration: {
      ...
      resultDelivery: "urlOrDataUrl",
      supportsImageEdit: false,
      notes: ["Image generation is disabled until a real DashScope image adapter is wired, so uploaded references cannot be silently ignored."],
    },
    supportedModes: ["poster", "collab", "announcement", "logo", "icon"],
