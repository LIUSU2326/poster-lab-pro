...
function stylePreviewClass(style: string, index: number): string {
  const rules: Array<[RegExp, string]> = [
    [/3D 潮流粘土|黏土定格|定格玩具/i, "preview-clay"],
    [/二次元|赛璐璐/i, "preview-anime"],
    [/史诗暗金|暗黑哥特|RPG/i, "preview-dark-rpg"],
    [/赛博霓虹|街机霓虹|霓虹/i, "preview-neon"],
    [/欧美扁平矢量|现代商务极简/i, "preview-vector"],
    [/国风水墨|国潮厚涂/i, "preview-ink"],
    [/复古街机像素|像素复古|街机/i, "preview-pixel"],
    [/仙侠流光云海/i, "preview-xianxia"],
    [/吉卜力|明亮童话|柔光治愈/i, "preview-ghibli"],
    [/电竞猛兽图腾/i, "preview-esports"],
    [/至尊钻金|轻奢产品/i, "preview-luxury"],
    [/街头涂鸦/i, "preview-graffiti"],
    [/蒸汽机械|蒸汽朋克/i, "preview-steampunk"],
    [/精致休闲奇幻|厚涂奇幻|魔幻写实/i, "preview-fantasy"],
    [/电影感|广告大片|欧美写实|荒野写实/i, "preview-cinematic"],
    [/漫画分镜/i, "preview-storyboard"],
    [/广告|产品/i, "preview-layout"],
    [/低多边形|几何/i, "preview-polygon"],
    [/水彩|手绘绘本|童趣手绘/i, "preview-watercolor"],
    [/美式卡通|可爱三渲二/i, "preview-cute-toon"],
    [/纸艺拼贴|剪纸舞台/i, "preview-paper"],
    [/复古海报/i, "preview-retro-poster"],
    [/硬表面3D|科幻机甲/i, "preview-hard-surface"],
    [/海岛度假/i, "preview-island"],
    [/森林冒险/i, "preview-forest"],
    [/油画质感/i, "preview-oil"],
  ];
