...
const currentVersion = "1.1.0-beta.1";
...
if (!testing.includes("1.1.0-beta.1 Quality Audit Refresh Release Update")) {
  issues.push("TESTING.md: missing 1.1.0-beta.1 quality audit refresh release section");
}
