...
const currentVersion = "1.1.0-beta.3";
...
if (!testing.includes("1.1.0-beta.3 Icon Edge Container Detection Release Update")) {
  issues.push("TESTING.md: missing 1.1.0-beta.3 icon edge container release section");
}
