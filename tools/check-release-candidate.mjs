...
const currentVersion = "1.0.0-beta.3";
...
if (!testing.includes("1.0.0-beta.3 Real Generation Acceptance Update")) {
  issues.push("TESTING.md: missing beta.3 real generation acceptance section");
}
