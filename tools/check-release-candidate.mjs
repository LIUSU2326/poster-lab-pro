...
const currentVersion = "1.1.0-beta.4";
...
if (!testing.includes("1.1.0-beta.4 Logo Copy-Safe Blank Wordmark Release Update")) {
  issues.push("TESTING.md: missing 1.1.0-beta.4 logo copy-safe blank release section");
}
